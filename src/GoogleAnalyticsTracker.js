...
export class GoogleAnalyticsTracker {
  ...
  /**
   * Track a enhance e-commerce event. This uses the Enhanced Ecommerce GA feature.
   * @param  {Object} product       An object with product values
   * @param  {String} eventCategory The event category, defaults to Ecommerce.
   * @param  {String} eventAction   The event action.
   */
  trackEnhanceECommerceEvent(product = {}, actionlistSource = '', actionListName = '', eventCategory = {}, eventAction = '') {
    GoogleAnalyticsBridge.trackEnhanceECommerceEvent(this.id, product, actionlistSource, actionListName, eventCategory, eventAction);
  };
  /**
